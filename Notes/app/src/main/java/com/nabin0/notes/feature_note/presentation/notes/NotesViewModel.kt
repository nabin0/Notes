package com.nabin0.notes.feature_note.presentation.notes
...
import com.nabin0.notes.feature_note.domain.usecase.NoteUseCases
...
@Inject constructor(
    ...
    private fun getNotes(noteOrder: NoteOrder) {
        getNotesJob?.cancel()
        getNotesJob = noteUseCases.getAllNotesUseCase(noteOrder).onEach { notes ->
                _state.value = state.value.copy(

...
import com.nabin0.notes.feature_note.presentation.notes.NotesEvent
import com.nabin0.notes.feature_note.presentation.notes.NotesViewModel
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = { viewModel.onEvent(NotesEvent.ToggleOrderSection) }) {
                    Icon(imageVector = Icons.Filled.Sort, contentDescription = "Sort Notes")
                }
            }
